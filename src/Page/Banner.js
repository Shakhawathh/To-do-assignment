...
const Banner = () => {
  return (
    <div>
      <div class="w-full bg-white bg-[url('https://i.ibb.co/X725PYT/ian-harber-cu7-Kou-Q5-FJE-unsplash.jpg')] bg-no-repeat bg-center bg-cover  ">
        <div class="relative items-center w-full px-5 py-12 mx-auto md:px-12 lg:px-16 max-w-7xl lg:py-24">
          <div class="flex w-full mx-auto text-left">
            <div class="relative inline-flex items-center mx-auto align-middle">
              <div class="pb-12 text-center">
                <h1 class="max-w-5xl text-2xl font-bold leading-none tracking-tighter text-teal-600 md:text-5xl lg:text-6xl lg:max-w-7xl">
                  To do list <br class="hidden lg:block" />
                  for your daily life
                </h1>
                ...
                >
                  <div class="flex-1 min-w-0 revue-form-group">
                    ...
                    <input
                      id="cta-email"
                      type="email"
                      class="block w-full px-5 py-3 text-base placeholder-gray-500 transition duration-500 ease-in-out transform bg-transparent border border-transparent rounded-md text-neutral-600 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300"
                  ...
                  <div class="mt-4 sm:mt-0 sm:ml-3 revue-form-actions">
                    <button
                      ...
                      id="member_submit"
                      class="block w-full px-5 py-3 text-base font-medium text-white bg-teal-700 border border-transparent rounded-lg shadow hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300 sm:px-10"
                    >
                      Notify me
                    </button>
                  </div>
